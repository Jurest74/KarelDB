...
public class Minero extends AugmentedRobot implements Directions {
	...
	private int idRobotActual = 0;
	private static int idCounter = 0;
	private static int beepersActuales = 0;
	...
	// from Parent classes.
	public Minero(int street, int avenue, Direction direction, int beepers, Color color, int tipo) {
		...
		RobotsDB(tipoRobot, idRobotActual, encendido = true, avenidaInicial, calleInicial, beepers);
		LogEventosDB(timestamp, idRobotActual, avenidaInicial, calleInicial, beepers);
	...
	private boolean logMensaje(String mensaje) {
		System.out.println("tipoRobot: " + tipoRobot + " - id: " + idRobotActual + " - " + mensaje);
		return (true);
	}
	...
	public static void crearRobots(int tipoRobot) {
		...
		for (int i = AVENIDA_INICIAL; i < (AVENIDA_INICIAL + cantidad); i++) {
			robot = new Minero(calle, i, North, beepersActuales, colorRobot, tipoRobot);
	...
	public static boolean RobotsDB(int tipoRobot, int idRobot, boolean encendido, int avenida, int calle, int beepers) {
		try {
			System.out.println(
					"//////////////////////////////////////// REGISTRO TABLA ROBOTS ////////////////////////////////////////");
			String command = "python3 main.py Robots --tipoRobot " + tipoRobot + " --idRobot " + idRobot
					+ " --encendido " + encendido + " --avenida " + avenida + " --calle " + calle + " --sirenas "
					+ beepers;
	...
	public static boolean LogEventosDB(String timeStamp, int idRobot, int avenida, int calle, int beepers) {
		try {
			System.out.println(
					"//////////////////////////////////////// REGISTRO TABLA LOGEVENT ////////////////////////////////////////");
			String command = "python3 main.py LogEventos --timeStamp \"" + timeStamp + "\" --idRobot " + idRobot
					+ " --avenida " + avenida + " --calle " + calle + " --sirenas " + beepers;
			String[] commandParts = command.split("\\s+");
			ProcessBuilder processBuilder = new ProcessBuilder(commandParts);
			processBuilder.redirectErrorStream(true);
	...
	public static boolean EstadoProgramaDB(String timeStamp, int estado) {
		try {
			System.out.println(
					"//////////////////////////////////////// REGISTRO TABLA ESTADO ////////////////////////////////////////");
			String command = "python3 main.py EstadoPrograma --timeStamp \"" + timeStamp + "\" --estado " + estado;
			String[] commandParts = command.split("\\s+");
			ProcessBuilder processBuilder = new ProcessBuilder(commandParts);
			processBuilder.redirectErrorStream(true);
